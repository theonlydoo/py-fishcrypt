...
## added new() function for compatibility (trubo)

if __name__ == '__main__':
    __module_name__ = 'pyBlowfish'
    __module_version__ = '0.5'
    __module_description__ = 'plain Python Blowfish lib'
